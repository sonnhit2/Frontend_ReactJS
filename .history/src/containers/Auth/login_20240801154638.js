...
class Login extends Component{
    ...
    //reactjs life-cycle method in Unmounting phrase, called when the component is about to be removed fom DOM
    componentWillUnmount(){
        document.removeEventListener('keydown', this.handlerKeyDown);
        // fix Warning: Can't perform a React state update on an unmouted component
